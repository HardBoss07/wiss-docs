...
- Ergebnisse
  - Konkrete, überprüfbare Produkte oder Leistungen, die im Projekt entstehen
- Risikomanagement
  - Potenzielles Ereignis, das den Projektverlauf negativ beeinflussen kann (SWOT-Analyse)
- Roadmap
  - Planung der Abläufe / Meilensteine (GANTT-Chart)
...
> Kommt von dem Wort **Kommune**

- Wie fängt Kommunikation an?:
  - Sender & Empfänger
  - Gesprächsthema
  - Sender (Kodieren) -> Medium (Allenfalls Störungen) -> Empfänger (Dekodieren)
- Wir speichern unsere Erfahrungen ab
- Störungen:
  - Falsche Wortwahl
  - Schwieriger Dialekt
  ...
  - Keine Hörbereitschaft
  - Schlechte soziale Beziehung
  - Zu wenige Informationen (Lücken)
  - Zu viele Informationen (Überladung)
  - Phrasendrescher
  - Widersprüchlicher Informationstransport
  - Schreibfehler

## 4 Ohren (Seiten) Modell

> Alles sind Äusserung von 4 Arten:
...
1. Regel 1 - Passende Rahmenbedingungen

   - Ist mein Gegenüber überhaupt in der Lage, meine Nachricht so zu empfangen, dass sie ankommt?
   - Passt der Ort, die Zeit, die Umgebung?
   - Brauche ich bzw. braucht mein Gegenüber evtl. Zeit, sich auf das Gespräch vorzubereiten?
...
4. Regel 4 - Sende "Ich-Botschaften"
   - Eine "Ich-Botschaft" beschreibt, was du verstehst
   - Eine "Ich-Botschaft" beschreibt, was du siehst
   - Eine "Ich-Botschaft" beschreibt, was du fühlst
   - Eine "Ich-Botschaft" ist nie angreifend
...
> Team erstellen
> Teamname: WISSDOM
> Im Team mit Efe, Abdul, Severin, Angelo
