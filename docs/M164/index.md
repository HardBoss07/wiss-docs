...
* Kunde hat meist *einen* Kontakt
* Fix: auf 1:1 ändern

**2. Kunde & Kontakt**
* doppelte Attribute (Name, Adresse)
* verletzt 3. NF
* Fix: Name/Adresse nur in *einer* Entität lassen

**3. Bestellung <-> Software**
* `SoftwareID` direkt in Bestellung -> nur 1 Software pro Bestellung
* Fix: neue Entität *Bestellposition* (`BestellungID`, `SoftwareID`, Menge, Preis)

**4. Software <-> Plattform**
* aktuell 1:m -> falsch
* Software kann mehrere Plattformen haben
* Fix: Zwischentabelle *Software_Plattform*
