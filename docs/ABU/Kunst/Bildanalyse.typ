...
#grid(
  ...
  [
    Hier schreibst du deine kurze Bildbeschreibung rein. Wer ist zu sehen?
    Wie ist die Körperhaltung? Welche Farben und Formen stechen sofort ins
    Auge? Da diese Spalte breiter ist, hast du hier genug Platz, um die
    ersten Zeilen deiner Analyse flüssig unterzubringen.
  ],
...
[Hier stellst du die Epoche allgemein vor. Was macht den Impressionismus aus? (z.B. Freilichtmalerei, Festhalten des flüchtigen Moments, sichtbare Pinselstriche).]

// Platzhalter für die Bilder 2 bis 4 (Drei Referenzbilder zur Epoche)
#grid(
  columns: (2fr, 3fr),
  gutter: 1em,
