# Dokumentation: Urkundenfälschung (Art. 251 StGB)
...
Die Urkundenfälschung hat eine grosse Bedeutung für Gesellschaft & Rechtssystem. Für den Bereich Sprache & Kommunikation zeigt sich, wie wichtig die schriftliche Fixierung & die Beweiskraft von Dokumenten sind. In einer Zeit, in der Dokumente zunehmend digitalisiert werden, gewinnt die Urkundenfälschung zusätzlich an Aktualität. Für den Bereich Gesellschaft ist relevant, dass Vertrauen in Verträge, Ausweise & Bescheinigungen eine Grundvoraussetzung für das Zusammenleben ist. Ein hoher Missbrauch würde dieses Vertrauen zerstören & die Rechtssicherheit gefährden.
